...
use EasyUmeng\Kernel\Support\Arr;
...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'easyumeng'], 'price', 100);
        self::assertSame(['name' => 'easyumeng', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'easyumeng']);
        self::assertSame(['name'], $keys);
        self::assertSame(['easyumeng'], $values);
    }
    ...
    {
        $array = ['name' => 'easyumeng', 'price' => 100];
        $array = Arr::except($array, ['price']);
        self::assertSame(['name' => 'easyumeng'], $array);
    }
    ...
    {
        $array = ['name' => 'easyumeng', 'price' => 100, 'orders' => 10];
    ...
    public function testPull()
    {
        ...
        self::assertSame('easyumeng', $name);
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@easyumeng.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        self::assertSame(['i@easyumeng.com' => 'Jane'], $array);
        // Does not work for nested keys
