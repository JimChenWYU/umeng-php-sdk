...
class CollectionTest extends TestCase
{
    ...
    {
        $data = new Collection(['first' => 'jimchen', 'last' => 'Otwell', 'email' => 'jimchen@easyumeng.com']);
        self::assertSame(['first' => 'jimchen'], $data->only(['first', 'missing'])->all());
        self::assertSame(['first' => 'jimchen', 'email' => 'jimchen@easyumeng.com'], $data->only(['first', 'email'])->all());
    }

    public function testExcept()
    {
        $data = new Collection(['first' => 'jimchen', 'last' => 'Otwell', 'email' => 'jimchen@easyumeng.com']);
        self::assertSame(['first' => 'jimchen'], $data->except(['last', 'email', 'missing'])->all());
        self::assertSame(['first' => 'jimchen'], $data->except('last', 'email', 'missing')->all());
        self::assertSame(['first' => 'jimchen', 'email' => 'jimchen@easyumeng.com'], $data->except(['last'])->all());
        self::assertSame(['first' => 'jimchen', 'email' => 'jimchen@easyumeng.com'], $data->except('last')->all());
    }
    ...
    public function testHas()
    {
        ...
        self::assertFalse($c->has('jimchen'));
    }
